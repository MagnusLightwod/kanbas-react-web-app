...
export default function KanbasNavigation() {
  return (
    ...
    bottom-0 top-0 d-none d-md-block bg-black z-2">
      ...
      <Link to="/Kanbas/Inbox" id="wd-inbox-link" className="list-group-item text-white bg-black text-center border-0"><FaInbox className="fs-1 text-danger"/><br />Inbox</Link>
