...
import { setCourseEnrollment } from "./redux/reducer"; // Assuming you have an action to set course enrollments
...
export default function Dashboard({
  ...
  // clicking the button will flip the value to true or false
